...
public class RPGMain {
    ...
    private void gold(Monster monster){
        TOTAL_GOLD = braver.getTOTAL_GOLD();
        TOTAL_GOLD += monster.getGold();
        braver.setTOTAL_GOLD(TOTAL_GOLD);

        System.out.printf("勇者%sの所持金は%dになった！",braver.getName(),TOTAL_GOLD);
    }
}
